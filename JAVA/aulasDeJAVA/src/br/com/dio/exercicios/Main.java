...
public class Main {
    ...
    public static void main(String[] args){
        ...
        int i; /*certo*/
        /*    int i; variável igual a anterior, não podemos usar o mesmo nome para variáveis diferente*/
        int I; /*case sensitive, faz diferenciação entre letras minusculas e letras maiusculas*/
        /* int 1; váriaveis não podem começar com numeros*/
        /* int _1a;
        int &1a;
